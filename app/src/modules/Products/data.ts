    ...
    bom: {
      ...
      groups:[
        ...
        { name:'Embedded Firmware', icon:'⌗', supplier:'VCycene Engineering · Lezhong', items:[
          { pn:'L3600-FW-0001', name:'STM32 Main CPU Firmware', spec:'Composting cycle control, motor drive, BME688 sensor polling, lid interlock — STM32U575VGT · Build: 3600-STM32-DVT-0001 · ✅ PP Ready · Lezhong (Jul 8): "Ready with a few release builds" · Shipped: LL01-AWP-002.002 (live to customers, promoted 2026-08-06; supersedes 001.017/001.018/001.019)', qty:1, unit:'build' },
          { pn:'L3600-FW-0002', name:'ESP32 P50 Connectivity Firmware', spec:'WiFi provisioning (BLE), MQTT telemetry uplink, signed OTA image relay to STM32 — ESP32-S3 (P50 module) · Build: 3600-ESP32-DVT-0001 · ⚠️ PP Ready (caveat) · SSL cert and signed OTA not yet implemented as of Jul 8 — must resolve before PVT · Update 2026-08-06: MQTT+TLS (per-machine cert) and HTTPS OTA now implemented, internal testing only via LL01-AWP-002.004; live customer firmware (002.002) still on plaintext-FTP OTA', qty:1, unit:'build' },
          ...
          { pn:'L3600-FW-0005', name:'MQTT Cloud Backend', spec:'Mosquitto broker + telemetry ingestor + per-device TLS/PKI cert provisioner · ⚠️ PP Ready (caveat) · Backend deployed ≥99% uptime. Cert provisioning just implemented Jul 8 — not yet tested end-to-end · Update 2026-08-06: per-device MQTT+TLS handshake (unique cert per machine, SOC 2 audit trail) now in internal testing via LL01-AWP-002.004', qty:1, unit:'service' },
          { pn:'L3600-FW-0007', name:'OTA Firmware Release Pipeline', spec:'Uploads signed binaries to GCS; sends COMMAND topic via MQTT; SOC2 audit-logged · ❌ Not PP Ready · Not tested, signing keys WIP as of Jul 8. OTA release pipeline is a PVT/MP blocker · Update 2026-08-06: OTA now delivered over HTTPS (transition off plaintext FTP) in internal testing via LL01-AWP-002.004 — still not customer-validated, remains a PVT/MP blocker', qty:1, unit:'tool' },
