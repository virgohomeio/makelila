...
alter table public.customers
  ...
  add column if not exists primary_user_phone text;
...
comment on column public.customers.primary_user_phone is
  'FR-6: optional contact phone for the primary user of the machine.';
