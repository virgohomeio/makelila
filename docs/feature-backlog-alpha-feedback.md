...
- **#61** Dashboard: label telemetry windows as "smelly" / "no smell" for future ML training data.
  ...
  **First labeling target (operator-confirmed 2026-06-04):** Kristen Pimentel (customer_id `44748ce9-d08f-436d-849f-1552f90701f3`, unit `LL01-00000000267`) reports her compost is smelly. As soon as this labeling UI ships, mark her telemetry window leading up to the report as `smelly` with `source='sms'` linked to ticket ST-2026-0248.
