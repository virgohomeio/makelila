...
- **#75** Diagnosis-call booking link on customer tickets + auto-invite Reina/Junaid to the resulting call.
...
- **#74** Verify the diagnosis-call booking link's event-type before wiring #75's auto-invite.
